...
import { CATEGORIES, YEAR, SITE_NAME } from '@/lib/categories'
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="font-display font-black text-xl text-white no-underline">
              fiets<span className="text-brand-red">voeter</span>.nl
            </Link>
            <p className="text-sm mt-3 text-gray-500 leading-relaxed">
              Onafhankelijke fietsreviews voor Nederland. Getest op eigen ritten in {YEAR}.
            </p>
          </div>
