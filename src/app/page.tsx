...
export const metadata: Metadata = {
  title: `${SITE_NAME} â Eerlijke Fietsreviews & Koopgidsen ${YEAR}`,
    ...
    <>
      <section className="bg-gray-50 border-b border-gray-200 py-16 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-brand-red mb-3">Wielrennen Â· MTB Â· Gravel Â· E-bike</p>
            ...
            <p className="text-gray-500 text-lg leading-relaxed mb-6 max-w-md">
              Onafhankelijk getest op eigen ritten in {YEAR}. Eerlijk advies voor elk budget â inclusief actuele bol.com prijzen.
            </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 border-b border-gray-200">
        {[{num:'200+',label:'Productreviews'},{num:'7',label:'CategorieÃ«n'},{num:'4.8â',label:'Gemiddeld oordeel'},{num:YEAR.toString(),label:'Bijgewerkt'}].map(({num,label})=>(
      ...
      <section className="max-w-6xl mx-auto px-4 pb-16">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/blog/" className="text-sm text-brand-red font-medium no-underline hover:underline">Alle artikelen â</Link>
        </div>
        {recent.length > 0 ? (
...
// TODO: Add TopTenSection import and component manually
