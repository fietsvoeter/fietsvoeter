...
export const metadata: Metadata = {
  ...
  title: {
    default: `${SITE_NAME} Ã¢ÂÂ Eerlijke Fietsreviews & Koopgidsen ${YEAR}`,
    template: `%s | ${SITE_NAME}`,
  },
  description: `Onafhankelijke fietsreviews getest op echte ritten in Nederland. Wielrennen, MTB, gravel en e-bike Ã¢ÂÂ actuele koopgidsen en onderhoudstips voor ${YEAR}.`,
  ...
  openGraph: {
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: `${SITE_NAME} Ã¢ÂÂ Eerlijke Fietsreviews Nederland`,
    }],
  },
  twitter: {
  ...
  return (
    <html lang="nl" className={`${barlow.variable} ${barlowCondensed.variable}`}>
      ...
      />
        ...
        {/* Snippet controle Ã¢ÂÂ Google mag snippets genereren maar niet uit nosnippet elementen */}
