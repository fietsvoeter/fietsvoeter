...
Sessie A: Squat 3x15, Romanian deadlift 3x15, hip thrust 3x15, plank 3x45s
Sessie B: Bulgarian split squat 3x12 per been, deadlift 3x12, dead bug 3x10, zijplank 3x30s

**Fase 2 , Opbouw (weken 5-8):**
Verhoog het gewicht, verlaag de herhalingen (8-10). Begin met compound bewegingen zwaarder te laden.

Sessie A: Back squat 4x8, deadlift 4x8, hip thrust 4x10, Pallof press 3x12
Sessie B: Bulgarian split squat 4x8, romanian deadlift 4x10, plank 3x60s, dead bug 3x10

**Fase 3 , Kracht (weken 9-12):**
Maximale krachtontwikkeling met lage herhalingen (4-6) en hoge gewichten. Explosieve uitvoering.

Sessie A: Back squat 4x5 zwaar, deadlift 4x4, hip thrust 4x6, core superset
Sessie B: Bulgarian split squat 4x6, romanian deadlift 4x5, explosieve varianten

Na het krachblok: schakel over naar onderhoud (1 sessie per week, 3x8 aan 70% van je maximum) terwijl je fietsvolume opvoert voor het nieuwe seizoen.
...
<CompareTable
  ...
  rows={[
    ["Back squat", "Quad, glutes, hamstring", "Traptechniek klimmen", "4x6-10", "Gevorderd"],
    ["Deadlift", "Hamstring, glutes, rug", "Klimkracht, houding", "4x5-8", "Gevorderd"],
    ["Bulgarian split squat", "Quad, glutes (eenzijdig)", "Pedaalbalans", "3x8-12", "Gemiddeld"],
    ["Hip thrust", "Glutes max", "Sprintkracht", "4x10-15", "Beginner"],
    ["Plank", "Diepe core", "Fietspositie stabiel", "3x30-90s", "Beginner"],
    ["Dead bug", "Core stabilisatie", "Energieoverdracht", "3x10", "Beginner"],
  ]}
  scoreCol={-1}
/>
