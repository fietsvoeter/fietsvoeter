...
<GeoBlock country="NL">
**📍 In Nederland?** Een kamp in Limburg is haalbaar voor een weekend — vrijdag vertrekken, zondag terug. Combineer met de Cauberg, de Bemelerberg en routes richting de Belgische Ardennen. Goedkoper dan Mallorca maar ook beperkter in klimvolume.
</GeoBlock>
...
<RelatedLinks
  links={[
    { href: "/blog/wielrennen-trainingsschema-8-weken/", label: "8-weken trainingsschema — complete periodisering" },
    { href: "/blog/intervaltraining-wielrennen/", label: "Intervaltraining wielrennen — complete methodiek" },
    ...
    { href: "/blog/slaap-herstel-wielrennen/", label: "Slaap en herstel — zo word je sterker" },
  ]}
/>
