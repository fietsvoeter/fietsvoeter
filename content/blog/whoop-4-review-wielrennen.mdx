...
- **Rusthartslagvariabiliteit (HRV)** â hoe variabel je hartslag is in rust
- **Rusthartslag (RHR)** â hoe laag je hartslag daalt tijdens slaap
- **Slaapkwaliteit** â hoeveel herstel je uit je slaap haalt
- **Ademhalingsfrequentie** â hoe stabiel je ademhaling is
...
<CompareTable
  ...
  rows={[
    ...
    ["Display","Nee","Ja","Ja"],
    ["Prijs","â¬30/mnd","â¬350-550","â¬300-450"]
  ]}
  scoreCol={-1}
/>
...
Tijdens trainingen is er geen scherm dat data laat zien. Dat dwingt je om op gevoel te rijden in plaats van obsessief naar cijfers te staren. Je checkt data achteraf in de app, wat een gezondere balans geeft tussen data en intuÃ¯tie.
...
Je betaalt â¬30/maand voor het basisabonnement (12 maanden verplicht). Dat is â¬360 per jaar. Ter vergelijking: een Garmin Forerunner koop je eenmalig en gebruikt hem 3-5 jaar. Over de levensduur ben je met Whoop duurder uit, maar je krijgt wel continue software-updates en een nieuwe band bij defect.
...
De kernvraag: **verbetert Whoop je trainingen genoeg om â¬30/maand te rechtvaardigen?**
...
- Je intuÃ¯tief goed aanvoelt wanneer je rust nodig hebt
- Je budget beperkt is en liever een fietscomputer koopt
- Je geen smartphone bij je hebt tijdens activiteiten

Voor wielrenners in de categorie "serieus maar niet-pro" die hun trainingsopbouw willen verbeteren en bereid zijn â¬30/maand te betalen, is Whoop een waardevolle toevoeging. Voor recreatieve fietsers die 2x per week een rondje maken is het overkill.

## Praktijkcases uit mijn test

### Case 1: Overtraining voorkomen

Week 3 van mijn opbouw naar een Gran Fondo. Ik had 4 dagen achter elkaar >150 km gereden en voelde me "okÃ©". Recovery daalde van 68% naar 41% naar 28%. Ik negeerde het en reed dag 5 nog een intervaltraining. Resultaat: week 4 ziek, recovery stabiliseerde pas na 10 dagen rust. Whoop voorspelde de overtraining, ik negeerde het.
...
Voor serieuze wielrenners die al een fietscomputer hebben en herstel willen optimaliseren is Whoop 8.7/10 waard. Voor recreatieve fietsers is een sporthorloge met Body Battery praktischer. En voor wielrenners die intuÃ¯tief goed hun lichaam aanvoelen is de â¬360/jaar misschien beter besteed aan een upgrade van je [trainingsrollers](/blog/tacx-neo-3m-review/).
...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "Nee. Whoop werkt alleen met een actief abonnement van minimaal 12 maanden aan â¬30/maand. Zonder abonnement is de band een stuk plastic. De band zelf krijg je bij het abonnement, je koopt hem niet los."
  },
  {
